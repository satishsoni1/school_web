...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-flask"></i> <?=$this->lang->line('panel_title')?>  (For Grade only subjects)</h3>
        <ol class="breadcrumb">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if(customCompute($sendExam) && customCompute($sendClasses) && customCompute($sendSubject)) { ?>
                ...
                <?php if(customCompute($students)) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            // foreach ($markpercentages as $data) {
                                                echo "<td data-title='Grade'>";
                                                    echo "<input class='form-control mark' type='text' name='mark-".$mark->markID."' id='grade' value='".$mark->grade."' />";
                                                echo "</td>";
                                            // }
                                        ?>
                    ...
                    <script type="text/javascript">
                        ...
                        $("#add_mark").click(function() {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "<?=base_url('mark/mark_send_grade')?>",
...
<script type="text/javascript">
    ...
    $("#classesID").change(function() {
        ...
        if(parseInt(classesID)) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('mark/subjectcall_optional')?>",
                data: {"id" : classesID},
                dataType: "html",
                success: function(data) {
                   $('#subjectID').html(data);
