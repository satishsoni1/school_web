                    ...
                    <h5 class="page-header">
                        <?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID') || $this->session->userdata('usertypeID') == 1)) { ?>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <a href="<?php echo base_url('mark/add_grade_only') ?>">
                                    <i class="fa fa-plus"></i>
                                    <?=$this->lang->line('add_title')?> (For Grade only subjects)
                                </a>

                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            
                                <a href="<?php echo base_url('mark/add_class9_marks') ?>" class="text-primary">
                                    <i class="fa fa-plus"></i>
                                    <?=$this->lang->line('add_title')?> (Class 9 Marks)
                                </a>
                            <?php } ?>
