                                                            ...
                                                            echo "<tr>";
                                                                ...
                                                                foreach ($marksetting as $subjectID => $markpercentageArr) {
                                                                    foreach ($markpercentageArr[(($settingmarktypeID==4) || ($settingmarktypeID==6)) ? 'unique' : 'own'] as $markpercentageID) {
                                                                        $markpercentagetypelabel = isset($markpercentages[$markpercentageID]) ? $markpercentages[$markpercentageID]->markpercentagetype.' ('.$markpercentages[$markpercentageID]->percentage.')' : '';
                                                                        
                                                                        echo "<th  class='text-center' style='background-color:#395C7F;color:#fff;' data-title='".$markpercentagetypelabel."'>";
