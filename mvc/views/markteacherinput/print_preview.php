...
<body>
    <table>
        ...
        <tr class="borderless">
            <td class="text-center borderless">UDISE NO.:27240312802</td>
        </tr>
        <tr class="borderless">
            <td class="text-center borderless">PROGRESS REPORT CARD (A.Y.<?= $schoolyear->schoolyear ?>)</td>
        </tr>
    </table>
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><?= customCompute($classes) ? $classes->classes : '' ?> (<?= customCompute($section) ? $section->section : '' ?>) Roll No.: <?= $student->srroll ?></td>
        </tr>
        <tr>
            <td>5. G.R. No.</td>
    ...
    <table class="table table-bordered">
        ...
        ?>
                <tr>
                    ...
                    if (customCompute($marksettings[1])) {
                    ?>
                    <td><?= $optional_marks[$examID][$subjectID] ?></td>
                    <?php
                    }
                    ?>
                    <td colspan=7><?= $subject->subject ?></td>
