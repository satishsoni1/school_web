...
$action_url = ($mode === 'edit') 
    ? base_url('students/update/' . $s['id']) 
    : base_url('students/save');
...
<div class="page-header">
    ...
    <a href="<?= base_url('students') ?>" class="btn btn-outline">← Back</a>
</div>
...
<div class="form-actions">
    ...
    <a href="<?= base_url('students') ?>" class="btn btn-outline btn-lg">Cancel</a>
</div>
