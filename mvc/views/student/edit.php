<?php
$isFatherNameAppended = TRUE;
if (isset($student->father_name) && !empty($student->father_name)) {
    $reconstructedWithoutName = trim(($student->first_name ?: '') . ' ' . ($student->surname ?: ''));
    if (trim($student->name) === $reconstructedWithoutName) {
        $isFatherNameAppended = FALSE;
    }
}
?>
<style>
        ...
        <form role="form" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('name') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="name_id" name="name" value="<?=set_value('name', $student->first_name)?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('surname') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="surname" name="surname" value="<?=set_value('surname', isset($student->surname) ? $student->surname : '')?>">
                    ...
                    <div class="form-group <?=form_error('father_name') ? 'has-error' : ''?>">
                        ...
                        <input type="text" class="form-control" id="father_name" name="father_name" value="<?=set_value('father_name', $student->father_name)?>">
                        <span class="text-danger"><?=form_error('father_name')?></span>
                        <div class="switch-container">
                            <label class="switch">
                                <input type="checkbox" name="append_father_name" id="append_father_name" value="yes" <?=set_checkbox('append_father_name', 'yes', $isFatherNameAppended)?>>
                    ...
                    <div class="form-group <?=form_error('mother_name') ? 'has-error' : ''?>">
                        ...
                        <input type="text" class="form-control" id="mother_name" name="mother_name" value="<?=set_value('mother_name', $student->mother_name)?>">
                        <span class="text-danger"><?=form_error('mother_name')?></span>
                    </div>

                    <div class="form-group <?=form_error('guardian_name') ? 'has-error' : ''?>">
                        <label for="guardian_name">Guardian Name</label>
                        <input type="text" class="form-control" id="guardian_name" name="guardian_name" value="<?=set_value('guardian_name', $student->guardian_name)?>">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('dob') ? 'has-error' : ''?>">
                                ...
                                <?php $dob = $student->dob ? date("d-m-Y", strtotime($student->dob)) : ''; ?>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('sex') ? 'has-error' : ''?>">
                                ...
                                <?=form_dropdown("sex", array($this->lang->line('student_sex_male') => $this->lang->line('student_sex_male'), $this->lang->line('student_sex_female') => $this->lang->line('student_sex_female')), set_value("sex", $student->sex), "id='sex' class='form-control'")?>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('nationality') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="nationality" name="nationality" value="<?=set_value('nationality', isset($student->nationality) ? $student->nationality : 'Indian')?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('mother_tongue') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="mother_tongue" name="mother_tongue" value="<?=set_value('mother_tongue', isset($student->mother_tongue) ? $student->mother_tongue : '')?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group <?=form_error('caste') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="caste" name="caste" value="<?=set_value('caste', isset($student->caste) ? $student->caste : '')?>">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group <?=form_error('sub_caste') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="sub_caste" name="sub_caste" value="<?=set_value('sub_caste', isset($student->sub_caste) ? $student->sub_caste : '')?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('admission_date') ? 'has-error' : ''?>">
                                ...
                                <?php $admission_date = $student->admission_date ? date("d-m-Y", strtotime($student->admission_date)) : ''; ?>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('saral_student_id') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="saral_student_id" name="saral_student_id" value="<?=set_value('saral_student_id', $student->saral_student_id)?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('pen_no') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="pen_no" name="pen_no" value="<?=set_value('pen_no', $student->pen_no)?>">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('aadhar_or_uid') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="aadhar_or_uid" name="aadhar_or_uid" value="<?=set_value('aadhar_or_uid', $student->aadhar_or_uid)?>">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('birth_place') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="birth_place" name="birth_place" value="<?=set_value('birth_place', isset($student->birth_place) ? $student->birth_place : '')?>">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('birth_taluka') ? 'has-error' : ''?>">
                                <label for="birth_taluka">Taluka</label>
                                <input type="text" class="form-control" id="birth_taluka" name="birth_taluka" value="<?=set_value('birth_taluka', isset($student->birth_taluka) ? $student->birth_taluka : '')?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group <?=form_error('birth_district') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="birth_district" name="birth_district" value="<?=set_value('birth_district', isset($student->birth_district) ? $student->birth_district : '')?>">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group <?=form_error('birth_state') ? 'has-error' : ''?>">
                                <label for="birth_state">State</label>
                                <input type="text" class="form-control" id="birth_state" name="birth_state" value="<?=set_value('birth_state', isset($student->birth_state) ? $student->birth_state : '')?>">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group <?=form_error('birth_country') ? 'has-error' : ''?>">
                                <label for="birth_country">Country</label>
                                <input type="text" class="form-control" id="birth_country" name="birth_country" value="<?=set_value('birth_country', isset($student->birth_country) ? $student->birth_country : 'India')?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('username') ? 'has-error' : ''?>">
                                <label for="username"><?=$this->lang->line("student_username")?> <span class="text-red">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group <?=form_error('emergency_phone') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" id="emergency_phone" name="emergency_phone" value="<?=set_value('emergency_phone', isset($student->emergency_phone) ? $student->emergency_phone : '')?>">
                    ...
                    <input type="hidden" name="country" id="country" value="<?=set_value('country', $student->country)?>">
            ...
            <div class="row">
                <div class="col-sm-12 text-right">
                    <input type="submit" class="btn btn-success btn-lg" style="padding: 10px 30px;" value="<?=$this->lang->line("update_student")?>">
                </div>
            </div>
        </form>
...
$(document).on('click', '#close-preview', function(){ 
    ...
    $('.image-preview').hover(
        function () { $('.image-preview').popover('show'); $('.content').css('padding-bottom', '130px'); }, 
