    ...
    <div class="box-body">
		...
		<div class="col-lg-12">
				<div id="hide-table">
					...
					<tr>
						<th>Title</th><td><?= $assignment->title ?></td>
					</tr>
					<tr>
						<th>Description</th><td><?= $assignment->description ?></td>
					</tr>
					<tr>
						<th>Deadline</th><td><?php echo date('d M Y', strtotime($assignment->deadlinedate)); ?></td>
					</tr>
					<tr>
						<th>File</th><td><?php 
