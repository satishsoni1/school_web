                                            ...
                                            <?php $invoice_total = 0; $invoice_weaver = 0; $invoice_fine = 0; $invoice_paid_fine = 0; if(customCompute($globalpayments)) { foreach ($globalpayments as $globalpayment) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $sql = "select maininvoiceID 
                                                        from invoice
                                                        join payment on payment.invoiceID=invoice.invoiceID
                                                        where payment.globalpaymentID=".$globalpayment->globalpaymentID." limit 1";
                                                        $CI = & get_instance();
                                                        $query = $CI->db->query($sql);
                                                        $maininvoice = $query->row();
                                                        $maininvoiceID = $maininvoice->maininvoiceID;
                                                        ?>
                                                        <a href="<?= base_url('invoice/print_previewviewpayment/'.$globalpayment->globalpaymentID.'/'.$maininvoiceID) ?>" target="_blank" class="btn btn-success btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="<?=$this->lang->line('view')?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="form-control" id="payment_type">
                                                            ...
                                                            <option value="cheque"><?=$this->lang->line('global_chaque')?></option>
                                                            <option value="online">Online</option>
                                                        </select>
                                                    </td>
                                                    <td>Date</td>
                                                    <td>
                                                        <input  name="payment_date" id="payment_date" class="form-control payment_date" type="date">
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
...
.refund {
  ...
  width:80%;
                        ...
                        $payment_method=""; $paymentedPaidStatus = FALSE; if(customCompute($paymenteds)) { foreach ($paymenteds as $paymented) { ?>
                                        <?php if($globalpayment->globalpaymentID == $paymented->globalpaymentID) { ?>
                                            <?php if($paymented->paymentamount > 0) { $paymentedPaidStatus = TRUE; ?>
                                                ...
                                                $payment_method = $paymented->paymenttype;
                                                ?>
            ...
            <tr>
				...
				<td style="text-align:left">
                    INV-G-<?=$globalpayment->globalpaymentID?>
				</td>
				<td>
				</td>
				<td style="width:18%">
                ...
                <?=isset($paidpayments['paiddate'][$globalpayment->globalpaymentID]) ? date('d-M-Y', strtotime($paidpayments['paiddate'][$globalpayment->globalpaymentID])) : '' ?>
				</td>
			</tr>
            <tr>
				<td colspan=5 style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Received Rs. 
					<span style="width:10px;border-bottom:1px solid #000">
						<b>
							<?= number_format($paymentedPaidAmount, 2) ?>
						</b>
					</span>
					(In Words) 
					<span style="width:10px;border-bottom:1px solid #000"><?= AmountInWords($paymentedPaidAmount) ?></span> 
					via Cheque No./Cash/Online <span style="width:10px;border-bottom:1px solid #000"><?= $payment_method ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 
					Drawn on <span style="width:10px;border-bottom:1px solid #000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 
					from Mr./Mrs. <span style="width:10px;border-bottom:1px solid #000"><?= ($single_student_info->father_name!=null)?$single_student_info->father_name:"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp" ?></span> 
					for admission in Grade <span style="width:10px;border-bottom:1px solid #000"><?=customCompute($single_classes) ? $single_classes->classes : ''?></span> 
					(1st/2nd/3rd Installments) for the year 2024-2025 Student's Name 
					<span style="width:10px;border-bottom:1px solid #000"><?=customCompute($single_student) ? $single_student->srname : ''?></span> 
			...
			<tr>
				...
				<td></td>
                            ...
                            <!-- <table class="table info">
                                ...
                                <tr>
                                    <td><center><b><span><?=$this->lang->line('global_student_copy')?></span></b></center></td>
                                </tr>
                            </table>
