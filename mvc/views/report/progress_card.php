...
<head>
    ...
    <title>Holistic Progress Card – <?= esc($student['student_name']) ?></title>
...
<div class="print-controls no-print">
    <div class="print-bar">
        <div class="print-brand">🏫 DWPS Holistic Progress Card</div>
        <div class="print-actions">
            <a href="<?= base_url('students/edit/' . $student['id']) ?>" class="btn-print-action btn-edit">✏️ Edit</a>
            <a href="<?= base_url('students') ?>" class="btn-print-action btn-back">← All Students</a>
...
<div class="pc-page">
    ...
    <div class="pc-school-header">
        ...
        <div class="school-info">
            <div class="school-tagline-hindi">संस्कार एवं विश्वस्तरीय शिक्षा साथ-साथ</div>
            <h1 class="school-name">DELHI WORLD PUBLIC SCHOOL</h1>
            <h2 class="school-location">CHARODA-BHILAI</h2>
            <p class="school-subtitle">Under the aegis of Delhi World Foundation, New Delhi</p>
        </div>
        <div class="school-contact">
            <p>Near Sai Mandir, Opposite Solar Power Plant,</p>
            <p>GE Road Charoda, Bhilai</p>
            <p>📧 info@dwpsbhilai.com</p>
            <p>📞 91091 20399, 91091 60399</p>
        </div>
    </div>
    ...
    <div class="student-info-strip">
        ...
        <div class="student-details">
            <div class="detail-row"><span class="detail-label">Student's Name:</span><span class="detail-value"><?= esc($student['student_name']) ?></span></div>
            <div class="detail-row"><span class="detail-label">Class:</span><span class="detail-value"><?= esc($student['class']) ?></span></div>
            <div class="detail-row"><span class="detail-label">Section:</span><span class="detail-value"><?= esc($student['section']) ?></span></div>
            <div class="detail-row"><span class="detail-label">Address:</span><span class="detail-value"><?= esc($student['address']) ?></span></div>
            <div class="detail-row"><span class="detail-label">Contact Number:</span><span class="detail-value"><?= esc($student['contact_number']) ?></span></div>
        </div>
    </div>
    ...
    <div class="pc-two-col">
        <div class="pc-col">
            ...
            <div class="about-grid">
                <div class="about-row"><b>My birthday is on</b> <?= esc($student['birthday']) ?></div>
                <div class="about-row"><b>I am</b> <?= esc($student['age']) ?> years old</div>
                <div class="about-row"><b>My mother tongue is</b> <?= esc($student['mother_tongue']) ?></div>
                <div class="about-row"><b>I want to be a/an</b> <?= esc($student['aspiration']) ?> when I grow up</div>
            </div>
            ...
            <div class="interests-box">
                ...
                <div class="interest-chips">
                    ...
                    <span class="interest-chip">✓ <?= esc($student['interest_other']) ?></span>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="favourites-box">
                <b>My favourite:</b>
                <div class="fav-grid">
                    <span>🎨 <?= esc($student['fav_colour']) ?: '–' ?></span>
                    <span>🍎 <?= esc($student['fav_foods']) ?: '–' ?></span>
                    <span>🎮 <?= esc($student['fav_games']) ?: '–' ?></span>
                    <span>🐾 <?= esc($student['fav_animal']) ?: '–' ?></span>
                    <span>🌸 <?= esc($student['fav_flower']) ?: '–' ?></span>
                    <span>🎉 <?= esc($student['fav_festival']) ?: '–' ?></span>
                </div>
            </div>
            ...
            <div class="measurements-row">
                <div class="meas-box">
                    ...
                    <p>Height: <?= esc($student['t1_height_handspan']) ?> handspan / <?= esc($student['t1_height_ft']) ?> ft</p>
                    <p>Weight: <?= esc($student['t1_weight_kg']) ?> kg</p>
                </div>
                <div class="meas-box">
                    <div class="meas-term term2-bg">Term 2</div>
                    <p>Height: <?= esc($student['t2_height_handspan']) ?> handspan / <?= esc($student['t2_height_ft']) ?> ft</p>
                    <p>Weight: <?= esc($student['t2_weight_kg']) ?> kg</p>
                </div>
            </div>
        </div>
        ...
        <div class="pc-col">
            ...
            <table class="sig-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $term ?></td>
                        <td><?= esc($signatures[$term]['parent_signature'] ?? '') ?><br><small><?= esc($signatures[$term]['parent_sign_date'] ?? '') ?></small></td>
                        <td><?= esc($signatures[$term]['teacher_signature'] ?? '') ?><br><small><?= esc($signatures[$term]['teacher_sign_date'] ?? '') ?></small></td>
                        <td><?= esc($signatures[$term]['principal_signature'] ?? '') ?><br><small><?= esc($signatures[$term]['principal_sign_date'] ?? '') ?></small></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
            ...
            <div class="family-box">
                ...
                <?php endif; ?>
                <p><b>Father:</b> <?= esc($student['father_name']) ?></p>
                <p><b>Mother:</b> <?= esc($student['mother_name']) ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="pc-page">
    ...
    <div class="pc-two-col">
        ...
        <div class="pc-col">
            ...
            <table class="assess-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $l ?></td>
                        <td><?= esc($self_assessment['Term1'][$f] ?? '') ?></td>
                        <td><?= esc($self_assessment['Term2'][$f] ?? '') ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <div class="pc-col">
            ...
            <div class="profile-text-box"><?= nl2br(esc($teacher_profile['profile_text'] ?? '')) ?></div>
            ...
            <table class="assess-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $l ?></td>
                        <td><?= esc($parent_feedback['Term1'][$f] ?? '') ?></td>
                        <td><?= esc($parent_feedback['Term2'][$f] ?? '') ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr>
