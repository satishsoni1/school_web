...
<body>
    ...
    <section class="page">
        ...
        <tr><td>Weight (Kg)</td><td><?= hpc_esc($healthT1Weight); ?></td><td><?= hpc_esc($healthT2Weight); ?></td></tr> -->
            ...
            <div class="foot">Page 1 / 18 – Cover</div>
        </div>
    </section>
    ...
    <section class="page">
        <div class="inner">
            ...
            <div class="foot">Page 2 / 18 – General Information</div>
        </div>
    </section>
    <!-- ══════════════════════════════════════════════════════════════
...
══════════════════════════════════════════════════════════════ -->
    <section class="page">
        <div class="inner">
            ...
            <div class="bar">Language - Sanskrit</div>
...
══════════════════════════════════════════════════════════════ -->
    <section class="page">
        <div class="inner">
            ...
            <div class="bar">Language - Sanskrit (continued)</div>
            <div class="domain mt">
                <div class="h">CG3 – Develops the ability to express understanding, experiences, feelings, and ideas in writing</div>
                <div class="b">
                    <table>
...
We show with placeholder variable $math_base for easy swap */
            $math_base = 52; // 3-lang: indices 40-58 | change to 52 for 4-lang
...
══════════════════════════════════════════════════════════════ -->
    ...
    <section class="page">
        <div class="inner">
            ...
            <?php
            $w_base = 71; // 3-lang: World starts at 59 | 4-lang: change to 71
...
══════════════════════════════════════════════════════════════ -->
    <section class="page">
        <div class="inner">
            ...
            <?php
            $a_base = 96; // 3-lang: Art starts at 84 | 4-lang: change to 96
            ...
            <?php
            $p_base = 99; // 3-lang: PE starts at 87 | 4-lang: change to 99
...
══════════════════════════════════════════════════════════════ -->
    <section class="page">
        <div class="inner">
            ...
            <?php
            $sel_base = 111; // 3-lang: SEL starts at 99 | 4-lang: change to 112
            ...
            <?php
            $plh_base = 116; // 3-lang: PLH starts at 104 | 4-lang: change to 117
...
══════════════════════════════════════════════════════════════ -->
    ...
    <section class="page">
        <div class="inner">
            <header class="head">
                <div class="logo"><img src="https://static.wixstatic.com/media/feee33_69d2a900adf0485a918168f1493bac96~mv2.png/v1/fill/w_122,h_122,al_c,q_85,enc_avif,quality_auto/PPGMIS%20logo_edited.png" alt="PPGMIS Logo"></div>
                <div class="school">
                    <h1>Observations &amp; Assessments</h1>
                    <p>Self, Peer, Parent and Teacher Inputs</p>
                </div>
                <div class="tag">Page 17</div>
            </header><br />
                    ...
                    <table class="assess-table" style="margin-top:0;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[0], 'Yes'); ?>">😃</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[0], 'Sometimes'); ?>">😐</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[0], 'No'); ?>">🙁</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[0], 'Not sure'); ?>">🤔</div>
                                </td>
                            </tr>
                            <tr>
                                <td class="question-col">I could complete work independently</td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[1], 'Yes'); ?>">😃</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[1], 'Sometimes'); ?>">😐</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[1], 'No'); ?>">🙁</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[1], 'Not sure'); ?>">🤔</div>
                                </td>
                            </tr>
                            <tr>
                                <td class="question-col">I followed classroom instructions</td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[2], 'Yes'); ?>">😃</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[2], 'Sometimes'); ?>">😐</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[2], 'No'); ?>">🙁</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($selfT1[2], 'Not sure'); ?>">🤔</div>
                                </td>
                            </tr>
                            <tr>
              <td colspan="5">
                    ...
                    <table class="assess-table" style="margin-top:0;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[0], 'Yes'); ?>">😃</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[0], 'Sometimes'); ?>">😐</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[0], 'No'); ?>">🙁</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[0], 'Not sure'); ?>">🤔</div>
                                </td>
                            </tr>
                            <tr>
                                <td class="question-col">Child shares learning materials</td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[1], 'Yes'); ?>">😃</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[1], 'Sometimes'); ?>">😐</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[1], 'No'); ?>">🙁</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[1], 'Not sure'); ?>">🤔</div>
                                </td>
                            </tr>
                            <tr>
                                <td class="question-col">Child supports team activities</td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[2], 'Yes'); ?>">😃</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[2], 'Sometimes'); ?>">😐</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[2], 'No'); ?>">🙁</div>
                                </td>
                                <td class="smiley-col">
                                    <div class="smiley-icon" style="<?= smiley_style($peerT1[2], 'Not sure'); ?>">🤔</div>
                                </td>
                            </tr>
                            <tr>
              <td colspan="5">
    ...
    <div class="card" style="margin-top:2mm;">
      <div class="row"><span class="value"><?= hpc_esc($peerNotes); ?></span></div>
            ...
            <br />
            <div class="foot">Page 17 / 18 – Assessments &amp; Observations</div>
        </div>
    </section>
    ...
    <section class="page">
      ...
      <div class="sig" style="text-align:center;">
        ...
        <div style="text-align:center; padding-top:0.8rem;">Dr. Gaurav N. Tiwari</div>
            ...
            <div class="foot">Page 18 / 18 – Final Summary</div>
        </div>
    </section>
