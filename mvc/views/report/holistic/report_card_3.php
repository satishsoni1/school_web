...
<head>
  ...
  <style>
    :root {
      --red: #d71f2b; --red-dark: #b5141f; --orange: #f28c1b; --orange-soft: #ffd8a6;
      --green: #0ea64b; --green-soft: #ddf8e7; --blue: #2f2d92; --blue-soft: #e4e6ff;
      --paper: #fffdf8; --bg: #f1ece2; --ink: #2d1d22; --line: #ead7b9;
    }
    * { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
    ...
    .page { width: 210mm; height: 297mm; margin: 5mm auto; background: var(--paper); border: 1px solid #eddfca; border-radius: 4mm; overflow: hidden; position: relative; box-shadow: 0 10px 28px rgba(0,0,0,.18); page-break-after: always; break-after: page; page-break-inside: avoid; break-inside: avoid; }
    .page:last-of-type { page-break-after: auto; break-after: auto; }
    .page::before, .page::after { content: ""; position: absolute; border-radius: 999px; z-index: 0; opacity: .13; pointer-events: none; }
    ...
    .inner { position: relative; z-index: 1; padding: 8mm; height: 100%; display: flex; flex-direction: column; gap: 1.2mm; }
    .inner::before { content: ""; position: absolute; left: 50%; top: 50%; transform: translate(-50%,-50%); width: 50mm; height: 50mm; background-image: url("https://static.wixstatic.com/media/feee33_69d2a900adf0485a918168f1493bac96~mv2.png/v1/fill/w_1400,h_1400,al_c,q_100,enc_auto/PPGMIS%20logo_edited.png"); background-repeat: no-repeat; background-position: center; background-size: contain; opacity: 0.2; pointer-events: none; z-index: 3; }
    .inner > * { position: relative; z-index: 2; }
    .head { display: grid; grid-template-columns: 24mm 1fr 32mm; gap: 3mm; align-items: center; border: 2px solid #ffc28a; border-radius: 5mm; background: linear-gradient(120deg, var(--red-dark), var(--red)); color: #fff; padding: 4mm; }
    .logo { height: 22mm; border-radius: 4mm; border: 2px solid var(--orange); background: #fff; display: flex; align-items: center; justify-content: center; padding: 1mm; }
    .logo img { width: 100%; height: 100%; object-fit: contain; }
    .school { text-align: center; }
    .school h1 { margin: .4mm 0; font-family: "Fredoka", sans-serif; font-size: 22px; line-height: 1.08; letter-spacing: .2px; color: #fff; }
    .school p  { margin: .2mm 0; font-size: 11.2px; font-weight: 700; line-height: 1.2; }
    .school .trust-line  { font-size: 10.5px; color: #ffe9bd; letter-spacing: .3px; font-weight: 800; }
    .school .school-line { text-transform: uppercase; }
    .school .meta-line   { font-size: 10px; color: #ffd59a; font-weight: 700; letter-spacing: .2px; }
    .tag { text-align: center; background: #fff; color: var(--red-dark); border: 2px solid var(--orange); border-radius: 999px; font-size: 14px; font-weight: 800; padding: 2mm 1mm; }
    .title { margin-top: 4mm; border: 2px dashed #f7b35e; background: linear-gradient(135deg, #fff, #fff4df); border-radius: 5mm; text-align: center; padding: 5mm; }
    ...
    .bar { margin-top: 3mm; border-radius: 999px; font-family: "Fredoka", sans-serif; font-size: 15px; color: #fff; padding: 1.5mm 4mm; font-weight: 700; letter-spacing: .2px; background: linear-gradient(90deg, var(--blue), #4744b9); }
    ...
    .card { background: #fff; border: 1.5px solid var(--line); border-radius: 4mm; padding: 3mm; }
    .card h3 { margin: 0 0 1.2mm; font-family: "Fredoka", sans-serif; color: var(--blue); font-size: 20px; }
    .row { display: flex; align-items: flex-end; gap: 2mm; font-size: 13.5px; font-weight: 700; border-bottom: 1px dashed #d8c4a8; padding: 1.5mm 0; }
    ...
    .photo { border: 2px dashed var(--orange); border-radius: 4mm; background: #fff8ef; min-height: 38mm; display: grid; place-items: center; text-align: center; font-size: 13px; font-weight: 700; color: #8b6e4d; overflow: hidden; }
    .passport-photo { width: 35mm; height: 45mm; margin: 2mm auto 4mm; border: 2px dashed var(--orange); border-radius: 3mm; background: #fff8ef; display: grid; place-items: center; text-align: center; font-size: 10px; font-weight: 700; color: #8b6e4d; padding: 2mm; overflow: hidden; }
    ...
    .domain { margin-top: 2.2mm; border: 1.5px solid #ecd7b9; border-radius: 4mm; overflow: hidden; background: #fff; }
    ...
    .sig .line { margin-top: 3mm; border-bottom: 1.4px solid #9f8a70; }
    ...
    .assess-table .smiley-col   { text-align: center; width: 13.75%; }
    .smiley-icon { display: inline-flex; align-items: center; justify-content: center; width: 38px; height: 38px; border: 1px solid #bbb; border-radius: 50%; font-size: 1.3em; background-color: #fcfcfc; color: #555; }
    ...
    .feel-sub  { font-size: 14px; color: #1f6a42; background: #edfdf3; padding: 1.7mm 3.4mm; font-weight: 600; border-bottom: 1px solid #d4ecd9; }
    .feel-table { margin-top: 0; font-size: 14px; }
    .feel-table th { background: #e6f8ed; color: #1d663e; font-size: 14px; padding: 1.6mm; }
    ...
    /* Floating Art */
    .art-strip { margin-top: 1.8mm; display: flex; align-items: center; justify-content: flex-end; gap: 2mm; }
    .art-icon  { width: 16mm; height: 10mm; display: inline-block; filter: drop-shadow(0 1px 1px rgba(0,0,0,.12)); }
    .art-float { position: absolute; z-index: 1; pointer-events: none; opacity: .85; }
    .art-float.left  { left: 3mm; bottom: 6mm; width: 12mm; height: 12mm; }
    .art-float.right { right: 3mm; bottom: 8mm; width: 14mm; height: 14mm; }

    .print-btn { position: fixed; right: 16px; bottom: 16px; border: 0; border-radius: 999px; background: var(--red-dark); color: #fff; font-family: "Fredoka", sans-serif; font-size: 13px; font-weight: 700; padding: 10px 18px; box-shadow: 0 8px 24px rgba(0,0,0,.25); cursor: pointer; z-index: 999; }
    @page { size: A4 portrait; margin: 0; }
    @media print {
      html, body { width: 100% !important; margin: 0 !important; padding: 0 !important; background: var(--bg) !important; }
      .page { width: 210mm !important; height: 297mm !important; margin: 0 !important; border: none !important; border-radius: 0 !important; box-shadow: none !important; page-break-after: always !important; break-after: page !important; overflow: hidden !important; }
  ...
  <div class="inner">
    ...
    <div class="card" style="margin-top:3mm;">
      ...
      <table>
        ...
        <tr><th>Measurement</th><th>Term 2</th></tr>
        <tr><td>Height (Ft/Cm)</td><td><?= hpc_esc($healthT2Ft); ?></td></tr>
        <tr><td>Weight (Kg)</td><td><?= hpc_esc($healthT2Weight); ?></td></tr>
      </table>
    </div>
    <div class="foot">Page 1 / 8 – Cover</div>
  </div>
</section>
...
<section class="page">
  <div class="inner">
    <header class="head">
      <div class="logo"><img src="https://static.wixstatic.com/media/feee33_69d2a900adf0485a918168f1493bac96~mv2.png/v1/fill/w_122,h_122,al_c,q_85,enc_avif,quality_auto/PPGMIS%20logo_edited.png" alt="PPGMIS Logo"></div>
      <div class="school"><h1>Part A – General Information</h1><p>To be filled by teacher in consultation with parents</p></div>
    ...
    <div class="feel-wrap">
      ...
      <table class="feel-table">
        <tr><th>Statement</th><th>Yes</th><th>Sometimes</th><th>No</th><th>Not Sure</th></tr>
        <?php
        $statements = [
    ...
    <div class="foot">Page 2 / 8 – General Information</div>
  </div>
</section>
...
<section class="page">
  <div class="inner">
    <header class="head">
      ...
      <div class="school"><h1>Part B – Holistic Development</h1><p>Physical Development</p></div>
      <div class="tag">Page 3</div>
    </header>
    <div class="bar">Physical Development Competencies</div><br/>
    <div class="domain">
      ...
      <div class="b">
        <table>
          ...
          <tr><td>C-1.1 Shows liking for nutritious food and does not waste food</td><td><?php print_comp($comps,'1','t1');?></td><td><?php print_comp($comps,'1','t2');?></td></tr>
          <tr><td>C-1.2 Practices basic self-care and hygiene</td><td><?php print_comp($comps,'2','t1');?></td><td><?php print_comp($comps,'2','t2');?></td></tr>
          <tr><td>C-1.6 Understands unsafe situations and asks for help</td><td><?php print_comp($comps,'3','t1');?></td><td><?php print_comp($comps,'3','t2');?></td></tr>
        </table>
      </div>
    </div><br/>
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-2.1 Differentiates shapes, colours and shades</td><td><?php print_comp($comps,'4','t1');?></td><td><?php print_comp($comps,'4','t2');?></td></tr>
          <tr><td>C-2.4 Differentiates smells and tastes</td><td><?php print_comp($comps,'5','t1');?></td><td><?php print_comp($comps,'5','t2');?></td></tr>
          <tr><td>C-2.5 Develops discrimination in sense of touch</td><td><?php print_comp($comps,'6','t1');?></td><td><?php print_comp($comps,'6','t2');?></td></tr>
        </table>
      </div>
    </div><br/>
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-3.2 Shows balance and coordination</td><td><?php print_comp($comps,'7','t1');?></td><td><?php print_comp($comps,'7','t2');?></td></tr>
          <tr><td>C-3.3 Shows precision using hands and fingers</td><td><?php print_comp($comps,'8','t1');?></td><td><?php print_comp($comps,'8','t2');?></td></tr>
          <tr><td>C-3.4 Shows strength and endurance in physical activity</td><td><?php print_comp($comps,'9','t1');?></td><td><?php print_comp($comps,'9','t2');?></td></tr>
        </table>
      </div>
    </div>
    <div class="foot">Page 3 / 8 – Physical Development</div>
  </div>
</section>

<!-- ══════════════════════════════════════ PAGE 4 – SOCIO-EMOTIONAL + COGNITIVE -->
<section class="page">
  <div class="inner">
    <header class="head">
      <div class="logo"><img src="https://static.wixstatic.com/media/feee33_69d2a900adf0485a918168f1493bac96~mv2.png" alt="Logo"/></div>
      <div class="school"><h1>Holistic Development</h1><p>Socio Emotional Development</p></div>
    ...
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-4.1 Recognises self as an individual</td><td><?php print_comp($comps,'10','t1');?></td><td><?php print_comp($comps,'10','t2');?></td></tr>
          <tr><td>C-4.2 Recognises and regulates emotions</td><td><?php print_comp($comps,'11','t1');?></td><td><?php print_comp($comps,'11','t2');?></td></tr>
          <tr><td>C-4.3 Interacts comfortably with children and adults</td><td><?php print_comp($comps,'12','t1');?></td><td><?php print_comp($comps,'12','t2');?></td></tr>
          <tr><td>C-4.6 Shows kindness and helpfulness</td><td><?php print_comp($comps,'13','t1');?></td><td><?php print_comp($comps,'13','t2');?></td></tr>
        </table>
      </div>
    </div>
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-5.1 Participates in helping activities</td><td><?php print_comp($comps,'14','t1');?></td><td><?php print_comp($comps,'14','t2');?></td></tr>
        </table>
      </div>
    </div>
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-6.1 Shows care for and joy in engaging with all life forms</td><td><?php print_comp($comps,'15','t1');?></td><td><?php print_comp($comps,'15','t2');?></td></tr>
        </table>
      </div>
    </div><br/>
    ...
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-7.1 Observes categories of objects</td><td><?php print_comp($comps,'16','t1');?></td><td><?php print_comp($comps,'16','t2');?></td></tr>
          <tr><td>C-7.2 Understands cause and effect</td><td><?php print_comp($comps,'17','t1');?></td><td><?php print_comp($comps,'17','t2');?></td></tr>
        </table>
      </div>
    </div>
    <div class="foot">Page 4 / 8 – Socio Emotional Development</div>
  </div>
</section>
...
<section class="page">
  <div class="inner">
    <header class="head">
      <div class="logo"><img src="https://static.wixstatic.com/media/feee33_69d2a900adf0485a918168f1493bac96~mv2.png" alt="Logo"/></div>
      <div class="school"><h1>Holistic Development</h1><p>Cognitive Development</p></div>
    ...
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-8.1 Sorts objects into groups and sub-groups based on properties</td><td><?php print_comp($comps,'18','t1');?></td><td><?php print_comp($comps,'18','t2');?></td></tr>
          <tr><td>C-8.2 Identifies and extends simple patterns in surroundings</td><td><?php print_comp($comps,'19','t1');?></td><td><?php print_comp($comps,'19','t2');?></td></tr>
          <tr><td>C-8.5 Recognises and uses numerals to represent quantities up to 99</td><td><?php print_comp($comps,'20','t1');?></td><td><?php print_comp($comps,'20','t2');?></td></tr>
          <tr><td>C-8.8 Recognises and classifies basic geometric shapes</td><td><?php print_comp($comps,'21','t1');?></td><td><?php print_comp($comps,'21','t2');?></td></tr>
          <tr><td>C-8.13 Formulates and solves simple mathematical problems</td><td><?php print_comp($comps,'22','t1');?></td><td><?php print_comp($comps,'22','t2');?></td></tr>
        </table>
      </div>
    </div>
    ...
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-9.1 Listens to songs, rhymes and poems</td><td><?php print_comp($comps,'23','t1');?></td><td><?php print_comp($comps,'23','t2');?></td></tr>
          <tr><td>C-9.3 Converses fluently</td><td><?php print_comp($comps,'24','t1');?></td><td><?php print_comp($comps,'24','t2');?></td></tr>
          <tr><td>C-9.4 Understands oral instructions</td><td><?php print_comp($comps,'25','t1');?></td><td><?php print_comp($comps,'25','t2');?></td></tr>
          <tr><td>C-9.5 Understands narrated stories</td><td><?php print_comp($comps,'26','t1');?></td><td><?php print_comp($comps,'26','t2');?></td></tr>
        </table>
      </div>
    </div>
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-10.1 Develops phonological awareness</td><td><?php print_comp($comps,'27','t1');?></td><td><?php print_comp($comps,'27','t2');?></td></tr>
          <tr><td>C-10.2 Understands structure of a book</td><td><?php print_comp($comps,'28','t1');?></td><td><?php print_comp($comps,'28','t2');?></td></tr>
          <tr><td>C-10.3 Recognises alphabet letters</td><td><?php print_comp($comps,'29','t1');?></td><td><?php print_comp($comps,'29','t2');?></td></tr>
          <tr><td>C-10.4 Reads passages with fluency</td><td><?php print_comp($comps,'30','t1');?></td><td><?php print_comp($comps,'30','t2');?></td></tr>
          <tr><td>C-10.5 Reads short stories and understands meaning</td><td><?php print_comp($comps,'31','t1');?></td><td><?php print_comp($comps,'31','t2');?></td></tr>
        </table>
      </div>
    </div>
    <div class="foot">Page 5 / 8 – Cognitive Development</div>
  </div>
</section>

<!-- ══════════════════════════════════ PAGE 6 – AESTHETIC + LEARNING HABITS -->
<section class="page">
  <div class="inner">
    <header class="head">
      <div class="logo"><img src="https://static.wixstatic.com/media/feee33_69d2a900adf0485a918168f1493bac96~mv2.png" alt="Logo"/></div>
      <div class="school"><h1>Holistic Development</h1><p>Language and Literacy Development</p></div>
    ...
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-12.1 Explores art materials</td><td><?php print_comp($comps,'32','t1');?></td><td><?php print_comp($comps,'32','t2');?></td></tr>
          <tr><td>C-12.2 Uses voice and movement for expression</td><td><?php print_comp($comps,'33','t1');?></td><td><?php print_comp($comps,'33','t2');?></td></tr>
          <tr><td>C-12.3 Shows imagination through art</td><td><?php print_comp($comps,'34','t1');?></td><td><?php print_comp($comps,'34','t2');?></td></tr>
        </table>
      </div>
    </div>
    ...
    <div class="domain">
      ...
      <div class="b">
        <table>
          <tr><th>Competency</th><th>Term 1</th><th>Term 2</th></tr>
          <tr><td>C-13.1 Focuses attention and plans activities</td><td><?php print_comp($comps,'35','t1');?></td><td><?php print_comp($comps,'35','t2');?></td></tr>
          <tr><td>C-13.3 Shows curiosity and exploration</td><td><?php print_comp($comps,'36','t1');?></td><td><?php print_comp($comps,'36','t2');?></td></tr>
        </table>
      </div>
    </div>
    <div class="domain">
    ...
    <div class="foot">Page 6 / 8 – Language Development</div>
  </div>
</section>

<!-- ════════════════════════════════ PAGE 7 – SELF / PEER ASSESSMENTS -->
<section class="page">
  <div class="inner">
    <header class="head">
      <div class="logo"><img src="https://static.wixstatic.com/media/feee33_69d2a900adf0485a918168f1493bac96~mv2.png/v1/fill/w_122,h_122,al_c,q_85,enc_avif,quality_auto/PPGMIS%20logo_edited.png" alt="PPGMIS Logo"></div>
    ...
    <br/>
    <div class="foot">Page 7 / 8 – Assessments &amp; Observations</div>
  </div>
</section>
...
<section class="page">
  <div class="inner">
    ...
    <header class="head">
      <div class="logo"><img src="https://static.wixstatic.com/media/feee33_69d2a900adf0485a918168f1493bac96~mv2.png/v1/fill/w_122,h_122,al_c,q_85,enc_avif,quality_auto/PPGMIS%20logo_edited.png" alt="PPGMIS Logo"></div>
      <div class="school"><h1>Part C – Annual Summary</h1><p>Holistic summary and sign-off</p></div>
    ...
    <table>
      <tr><th>Domain</th><th>Beginner</th><th>Proficient</th><th>Advanced</th></tr>
      <tr>
    ...
    <div class="foot">Page 8 / 8 – Final Summary</div>
  </div>
</section>
