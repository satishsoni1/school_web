    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="form-group col-sm-4" id="outstandingDiv">
                    <label>Outstanding/All Student</label>
                    <?php
                        $studentArray = array(
                            "yes" => "Outstanding",
                            "all" => "All",
                        );
                        echo form_dropdown("outstanding", $studentArray, set_value("outstanding"), "id='outstanding' class='form-control select2'");
                     ?>
                </div>
