<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            ...
            $pdf_preview_uri = base_url('balancefeesreport/pdf/'.$classesID.'/'.$sectionID.'/'.$studentID."/".$outstanding);
            $xml_preview_uri = base_url('balancefeesreport/xlsx/'.$classesID.'/'.$sectionID.'/'.$studentID."/".$outstanding);
