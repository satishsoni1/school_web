        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="form-group col-sm-4" id="fromdateDiv">
                    <label>Month<span class="text-red"> * </span></label>
                   <input class="form-control" type="month" name="month" id="monthSelect">
                </div>
                <div class="form-group col-sm-4" id="fromdateDiv">
        ...
        $(document).ready(function () {
            $('#monthSelect').on('change', function () {
                ...
                if (selectedMonth) {
                    ...
                    $('#fromdate').val(`01-${month}-${year}`);
                    // Calculate the last day of the month
                    const lastDay = new Date(year, month, 0).getDate();
                    // Set the "to" date to the last day of the month
                    $('#todate').val(`${lastDay.toString().padStart(2, '0')}-${month}-${year}`);
                }
            });
        });
