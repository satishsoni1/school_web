        ...
        <div class="col-sm-12">
            <div id="printablediv">
                <table class="table">
                    <tr>
                        <td>
                            Khalapur Taluka Shikshan Prasarak Mandal's
                            P.P. GAGANGIRI MAHARAJ INTERNATIONAL SCHOOL,
                            khopoli
                            (Proposed CBSE), UDISE NO.: 27240312802
                            Ref.No.:PPGMIS/ /2023-2024
                            Date: <?= date('d/M/Y') ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            This is to certify that Master. Shivansh Sanjay Rathod son of Mr. Sanjay Rathod of Prep 2 is studying in our school. The tuition fees for the AY- 2023-2024 is 27,000 ( Twenty Seven Thousand only). He has paid his tuition fees.
