...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_ledgers')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
                ...
                <form class="form-horizontal" role="form" method="post">
                   ...
                   <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="ledgers" name="ledgers" value="<?=set_value('ledgers', $ledgers->ledgers)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" style="resize:none;" id="note" name="note"><?=set_value('note', $ledgers->note);?></textarea>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_ledger")?>" >
                        </div>
                    </div>
