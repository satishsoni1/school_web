                        ...
                        <tbody>
                            <?php if (customCompute($onlineExams)) {
                                ...
                                foreach ($onlineExams as $onlineExam) {
                                    if ($usertypeID == '3') {
                                        if ((($student->srclassesID == $onlineExam->classID) || ($onlineExam->classID == '0')) && (($student->srsectionID == $onlineExam->sectionID) || ($onlineExam->sectionID == '0')) && (($student->srstudentgroupID == $onlineExam->studentGroupID) || ($onlineExam->studentGroupID == '0')) && (($onlineExam->subjectID == '0') || (in_array($onlineExam->subjectID, $userSubjectPluck)))) {
                                            $i++;
                                            ...
                                            <tr>
                                                ...
                                                <td data-title="<?= $this->lang->line('take_exam_duration') ?>">
                                                    ...
                                                    if (isset($onlineExam->startDateTime) && isset($onlineExam->endDateTime)) {
                                                        echo date("d/M/Y", strtotime($onlineExam->startDateTime)) . ' - ' . date('d/M/Y', strtotime($onlineExam->endDateTime));
                                                    }
                                                    ?>
                                                </td>
