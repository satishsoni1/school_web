                    ...
                    <div class="col-sm-12">
                        <div class="info-box">
                            ...
                            <p>
                                ...
                                <?=customCompute($instruction) ? namesorting($instruction->title,50) : ''?>
                            </p>
                            <p>
                                <span><?=$this->lang->line('online_exam_class')?> : </span>
                                <?=customCompute($class) ? $class->classes : ''?>
                            </p>
                            <p>
                                <span><?=$this->lang->line('online_exam_section')?> : </span>
                                <?=customCompute($section) ? $section->section : ''?>
                            </p>
                            <p>
                                <span><?=$this->lang->line('online_exam_studentGroup')?> : </span>
                                <?=customCompute($studentGroup) ? $studentGroup->group : ''?>
                            </p>
                            <p>
                                <span><?=$this->lang->line('online_exam_subject')?> : </span>
                                <?=customCompute($subject) ? $subject->subject : ''?>
                            </p>
                            <p>
