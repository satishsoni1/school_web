            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-right">
                    ...
                    <li class="dropdown notifications-menu">
                            <a target="_blank" href="<?=base_url('dashboard/fee_receipt_pdf')?>" class="dropdown-toggle" data-toggle="tooltip" title="Fee Receipt Format" data-placement="bottom">
                                <i class="fa fa-file"> Receipt format</i>
                            </a>
                        </li>
                        <?php } ?>
                        <li class="dropdown notifications-menu">
