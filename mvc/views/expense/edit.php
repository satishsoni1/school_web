    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-10">
                ...
                <?php 
                        if(form_error('ledgersID')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="ledgersID" class="col-sm-2 control-label">
                            Ledger Head <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                        <?php
                        $ledgersArray = array("0" => "Select Ledger Head");
                        foreach ($ledgers as $ledger) {
                            $ledgersArray[$ledger->ledgersID] = $ledger->ledgers;
                        }
                        echo form_dropdown("ledgersID", $ledgersArray, set_value("ledgersID",$expense->ledgersID), "id='ledgersID' class='form-control select2'");
                        ?>
                        </div> 
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('ledgersID'); ?>
                        </span>
                    </div>
                    <?php 
