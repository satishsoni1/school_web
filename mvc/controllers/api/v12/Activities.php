...
class Activities extends Api_Controller
{
    ...
    public function index_get()
    {
        ...
        $activitiesmedia = empty(pluck_multi_array($this->activitiesmedia_m->get_activitiesmedia(), 'obj', 'activitiesID'))
            ? (object) []
            : (object) pluck_multi_array($this->activitiesmedia_m->get_activitiesmedia(), 'obj', 'activitiesID');
        $activitiescomments = empty(pluck_multi_array($this->activitiescomment_m->get_order_by_activitiescomment(array('schoolyearID' => $schoolyearID)), 'obj', 'activitiesID'))
            ? (object) []
            : (object) pluck_multi_array($this->activitiescomment_m->get_order_by_activitiescomment(array('schoolyearID' => $schoolyearID)), 'obj', 'activitiesID');
        ...
        $this->retdata['activitiescomments'] = $activitiescomments;
