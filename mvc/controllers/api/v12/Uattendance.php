...
class Uattendance extends Api_Controller 
{
    ...
    public function index_get() 
    {
        ...
        $myProfile = false;
        if(isset($usertype[$this->session->userdata('usertypeID')]) && !permissionChecker('uattendance_view')) {
            $myProfile = true;
        }
            ...
            if(inputCall()) {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    if(customCompute($users)) {
                        ...
                        $this->retdata['dateinfo']['day']  = date('l', strtotime((string) $date));
                        $this->retdata['dateinfo']['date'] = date('jS F Y', strtotime((string) $date));
