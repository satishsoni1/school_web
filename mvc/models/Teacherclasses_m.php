...
class Teacherclasses_m extends CI_Model {
	...
	public function teacherClass() {
        ...
        return mergeArray(mergeArray($classResult, $routineResult, 'classesID'),$subjectResult, 'classesID');
	}
	...
	public function get_single_teacher_name($classesID) {
		$this->db->select('t.name,t.sign');
